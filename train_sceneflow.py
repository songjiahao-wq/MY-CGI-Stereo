...
parser.add_argument('--datapath', default="/home/mm/sjh/DATA/", help='data path')
parser.add_argument('--trainlist', default='./filenames/train_dataset_middlebury_sceneflow.txt', help='training list')
parser.add_argument('--testlist',default='./filenames/test_dataset_middlebury_sceneflow.txt', help='testing list')
